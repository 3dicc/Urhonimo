...
var E_WORKITEMCOMPLETED* {.importc: "E_WORKITEMCOMPLETED", header: "WorkQueue.h".}: StringHash# = "WorkItemCompleted"

var P_ITEM* {.importc: "P_ITEM", header: "WorkQueue.h".}: StringHash# = "Item"


discard "forward decl of WorkerThread"
type
  WorkItem* {.importcpp: "Urho3D::WorkItem", header: "WorkQueue.h".} = object of RefCounted
...
proc constructWorkItem*(): WorkItem {.importcpp: "Urho3D::WorkItem(@)",
                                      header: "WorkQueue.h", constructor.}
...
proc constructWorkQueue*(context: ptr Context): WorkQueue {.
    importcpp: "Urho3D::WorkQueue(@)", header: "WorkQueue.h", constructor.}
