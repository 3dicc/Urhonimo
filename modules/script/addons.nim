...
type 
  CScriptArray* {.importc: "Urho3D::CScriptArray", header: "Addons.h".} = object 
...
type 
  CScriptDictionary* {.importc: "Urho3D::CScriptDictionary", header: "Addons.h".} = object 
...
proc getKeys*(this: CScriptDictionary): ptr CScriptArray {.noSideEffect, 
  ...
  type 
    CIterator* {.importc: "Urho3D::CIterator", header: "Addons.h".} = object 
