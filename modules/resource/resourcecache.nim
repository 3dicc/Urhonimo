...
type
  ResourceGroup* {.importcpp: "Urho3D::ResourceGroup", header: "ResourceCache.h".} = object
...
proc constructResourceGroup*(): ResourceGroup {.constructor,
...
type
  ResourceRouter* {.importcpp: "Urho3D::ResourceRouter", header: "ResourceCache.h".} = object of UrObject


proc constructResourceRouter*(context: ptr Context): ResourceRouter {.constructor,
...
type
  ResourceCache* {.importcpp: "Urho3D::ResourceCache", header: "ResourceCache.h".} = object of UrObject
