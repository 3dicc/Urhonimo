...
type
  JSONValue* {.importcpp: "Urho3D::JSONValue", header: "JSONValue.h".} = object
...
proc constructJSONValue*(): JSONValue {.importcpp: "Urho3D::JSONValue(@)",
   constructor,                                     header: "JSONValue.h".}
proc constructJSONValue*(file: ptr JSONFile; value: ptr Rapidjson.Value): JSONValue {.
    importcpp: "Urho3D::JSONValue(@)", header: "JSONValue.h", constructor.}
proc constructJSONValue*(rhs: JSONValue): JSONValue {.constructor,
