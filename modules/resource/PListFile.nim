...
type 
  PListValueMap* {.importc: "Urho3D::PListValueMap", header: "PListFile.h".} = object of HashMap[
      UrString, PListValue]
...
type 
  ...
  PListValue* {.importc: "Urho3D::PListValue", header: "PListFile.h".} = object 
    `type`* {.importc: "type_".}: PListValueType


proc constructPListValue*(): PListValue {.importcpp: "Urho3D::PListValue(@)", 
    header: "PListFile.h".}
proc constructPListValue*(value: cint): PListValue {.
    importcpp: "Urho3D::PListValue(@)", header: "PListFile.h".}
proc constructPListValue*(value: bool): PListValue {.
    importcpp: "Urho3D::PListValue(@)", header: "PListFile.h".}
proc constructPListValue*(value: cfloat): PListValue {.
    importcpp: "Urho3D::PListValue(@)", header: "PListFile.h".}
proc constructPListValue*(value: UrString): PListValue {.
    importcpp: "Urho3D::PListValue(@)", header: "PListFile.h".}
proc constructPListValue*(valueMap: var PListValueMap): PListValue {.
    importcpp: "Urho3D::PListValue(@)", header: "PListFile.h".}
proc constructPListValue*(valueVector: var PListValueVector): PListValue {.
    importcpp: "Urho3D::PListValue(@)", header: "PListFile.h".}
proc constructPListValue*(value: PListValue): PListValue {.
    importcpp: "Urho3D::PListValue(@)", header: "PListFile.h".}
...
proc constructPListFile*(context: ptr Context): PListFile {.
