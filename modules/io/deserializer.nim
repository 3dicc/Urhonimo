...
type
  Deserializer* {.importcpp: "Urho3D::Deserializer", header: "Deserializer.h",
                  inheritable.} = object
    position* {.importc: "position_".}: cuint
    size* {.importc: "size_".}: cuint


proc constructDeserializer*(): Deserializer {.constructor,
    importcpp: "Urho3D::Deserializer(@)", header: "Deserializer.h".}
proc constructDeserializer*(size: cuint): Deserializer {.constructor,
    importcpp: "Urho3D::Deserializer(@)", header: "Deserializer.h".}
