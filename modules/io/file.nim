...
converter toSer*(x: ptr UrFile): ptr Serializer {.importcpp: "(@)", header: "File.h".}
converter toDeser*(x: ptr UrFile): ptr Deserializer {.importcpp: "(@)", header: "File.h".}
