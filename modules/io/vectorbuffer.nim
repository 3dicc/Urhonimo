...
type 
  VectorBuffer* {.importc: "Urho3D::VectorBuffer", header: "VectorBuffer.h".} = object of Deserializer
    buffer* {.importc: "buffer_".}: PODVector[cuchar]


proc constructVectorBuffer*(): VectorBuffer {.
    importcpp: "Urho3D::VectorBuffer(@)", header: "VectorBuffer.h".}
proc constructVectorBuffer*(data: PODVector[cuchar]): VectorBuffer {.
    importcpp: "Urho3D::VectorBuffer(@)", header: "VectorBuffer.h".}
proc constructVectorBuffer*(data: pointer; size: cuint): VectorBuffer {.
    importcpp: "Urho3D::VectorBuffer(@)", header: "VectorBuffer.h".}
