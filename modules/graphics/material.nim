...
type
  MaterialShaderParameter* {.importcpp: "Urho3D::MaterialShaderParameter",
...
type
  TechniqueEntry* {.importcpp: "Urho3D::TechniqueEntry", header: "Material.h".} = object
...
proc constructTechniqueEntry*(): TechniqueEntry {.constructor,
...
proc constructTechniqueEntry*(tech: ptr Technique; qualityLevel: cuint;
    ...
    importcpp: "Urho3D::TechniqueEntry(@)", header: "Material.h", constructor.}
proc destroyTechniqueEntry*(this: var TechniqueEntry) {.
    importcpp: "#.~TechniqueEntry()", header: "Material.h".}

type
  ShaderParameterAnimationInfo* {.importcpp: "Urho3D::ShaderParameterAnimationInfo",
                                  header: "Material.h".} = object of ValueAnimationInfo
    name* {.importc: "name_".}: UrString

type
  BiasParameters* {.importcpp: "Urho3D::BiasParameters", header: "Light.h".} = object
    constantBias* {.importc: "constantBias_".}: cfloat
    slopeScaledBias* {.importc: "slopeScaledBias_".}: cfloat

  Material* {.importcpp: "Urho3D::Material", header: "Material.h".} = object of Resource
...
proc constructShaderParameterAnimationInfo*(material: ptr Material;
    ...
    speed: cfloat): ShaderParameterAnimationInfo {.constructor,
...
proc constructMaterial*(context: ptr Context): Material {.constructor,
