...
proc constructBiasParameters*(): BiasParameters {.constructor,
...
proc constructBiasParameters*(constantBias: cfloat; slopeScaledBias: cfloat): BiasParameters {.
    importcpp: "Urho3D::BiasParameters(@)", header: "Light.h", constructor.}
proc validate*(this: var BiasParameters) {.importcpp: "Validate",
    header: "Light.h".}

type
  CascadeParameters* {.importcpp: "Urho3D::CascadeParameters", header: "Light.h".} = object
    splits* {.importc: "splits_".}: array[4, cfloat]
    fadeStart* {.importc: "fadeStart_".}: cfloat
    biasAutoAdjust* {.importc: "biasAutoAdjust_".}: cfloat


proc constructCascadeParameters*(): CascadeParameters {.constructor,
...
proc constructCascadeParameters*(split1: cfloat; split2: cfloat; split3: cfloat;
    ...
    importcpp: "Urho3D::CascadeParameters(@)", header: "Light.h", constructor.}
...
type
  FocusParameters* {.importcpp: "Urho3D::FocusParameters", header: "Light.h".} = object
...
proc constructFocusParameters*(): FocusParameters {.constructor,
...
proc constructFocusParameters*(focus: bool; nonUniform: bool; autoSize: bool;
    ...
    importcpp: "Urho3D::FocusParameters(@)", header: "Light.h", constructor.}
proc validate*(this: var FocusParameters) {.importcpp: "Validate",
    header: "Light.h".}

type
  Light* {.importcpp: "Urho3D::Light", header: "Light.h".} = object of Drawable
...
proc constructLight*(context: ptr Context): Light {.constructor,
