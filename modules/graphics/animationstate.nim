...
import
  hashMap, ptrs, skeleton, refcounted
...
type
  AnimationStateTrack* {.importcpp: "Urho3D::AnimationStateTrack",
...
proc constructAnimationStateTrack*(): AnimationStateTrack {.constructor,
...
type
  AnimationState* {.importcpp: "Urho3D::AnimationState",
...
when false:
  proc constructAnimationState*(model: ptr AnimatedModel; animation: ptr Animation): AnimationState {.
      importcpp: "Urho3D::AnimationState(@)", header: "AnimationState.h", constructor.}
