...
type
  Pass* {.importcpp: "Urho3D::Pass", header: "Technique.h".} = object of RefCounted
...
proc constructPass*(`type`: StringHash): Pass {.importcpp: "Urho3D::Pass(@)",
    header: "Technique.h", constructor.}
...
proc constructTechnique*(context: ptr Context): Technique {.
    importcpp: "Urho3D::Technique(@)", header: "Technique.h", constructor.}
