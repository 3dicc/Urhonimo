...
type
  LightQueryResult* {.importcpp: "Urho3D::LightQueryResult", header: "View.h".} = object
...
type
  ScenePassInfo* {.importcpp: "Urho3D::ScenePassInfo", header: "View.h".} = object
...
type
  PerThreadSceneResult* {.importcpp: "Urho3D::PerThreadSceneResult",
...
type
  View* {.importcpp: "Urho3D::View", header: "View.h".} = object of UrObject
  ...
  Viewport* {.importcpp: "Urho3D::Viewport", header: "Viewport.h".} = object of UrObject
...
proc constructViewport*(context: ptr Context): Viewport {.
    importcpp: "Urho3D::Viewport(@)", header: "Viewport.h", constructor.}
