...
type
  Billboard* {.importcpp: "Urho3D::Billboard", header: "BillboardSet.h".} = object
...
#var MAX_BILLBOARDS* {.importc: "MAX_BILLBOARDS", header: "BillboardSet.h".}: cuint


type
  BillboardSet* {.importcpp: "Urho3D::BillboardSet", header: "BillboardSet.h".} = object of Drawable
...
proc getTypeNameStatic*(): Urho3D.UrString {.
    ...
    header: "BillboardSet.h".}
proc constructBillboardSet*(context: ptr Context): BillboardSet {.constructor,
