...
type
  DecalVertex* {.importcpp: "Urho3D::DecalVertex", header: "DecalSet.h".} = object
...
type
  DecalSet* {.importcpp: "Urho3D::DecalSet", header: "DecalSet.h".} = object of Drawable
...
proc constructDecalSet*(context: ptr Context): DecalSet {.
    importcpp: "Urho3D::DecalSet(@)", header: "DecalSet.h", constructor.}
