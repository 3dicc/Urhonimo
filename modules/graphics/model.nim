...
type
  VertexBufferMorph* {.importcpp: "Urho3D::VertexBufferMorph", header: "Model.h".} = object
...
type
  ModelMorph* {.importcpp: "Urho3D::ModelMorph", header: "Model.h".} = object
...
type
  VertexBufferDesc* {.importcpp: "Urho3D::VertexBufferDesc", header: "Model.h".} = object
    vertexCount* {.importc: "vertexCount_".}: cuint
    elementMask* {.importc: "elementMask_".}: cuint
    dataSize* {.importc: "dataSize_".}: cuint
...
type
  IndexBufferDesc* {.importcpp: "Urho3D::IndexBufferDesc", header: "Model.h".} = object
...
type
  GeometryDesc* {.importcpp: "Urho3D::GeometryDesc", header: "Model.h".} = object
...
type
  Model* {.importcpp: "Urho3D::Model", header: "Model.h".} = object of Resource
...
proc constructModel*(context: ptr Context): Model {.
    importcpp: "Urho3D::Model(@)", header: "Model.h", constructor.}
