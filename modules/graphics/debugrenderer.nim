...
type
  DebugLine* {.importcpp: "Urho3D::DebugLine", header: "DebugRenderer.h".} = object
...
proc constructDebugLine*(): DebugLine {.importcpp: "Urho3D::DebugLine(@)",
                                        header: "DebugRenderer.h", constructor.}
proc constructDebugLine*(start: Vector3; `end`: Vector3; color: cuint): DebugLine {.
    importcpp: "Urho3D::DebugLine(@)", header: "DebugRenderer.h", constructor.}

type
  DebugTriangle* {.importcpp: "Urho3D::DebugTriangle", header: "DebugRenderer.h".} = object
...
proc constructDebugTriangle*(): DebugTriangle {.constructor,
...
type
  DebugRenderer* {.importcpp: "Urho3D::DebugRenderer", header: "DebugRenderer.h".} = object of Component
