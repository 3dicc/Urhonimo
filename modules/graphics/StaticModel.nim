...
type 
  StaticModelGeometryData* {.importc: "Urho3D::StaticModelGeometryData", 
...
type 
  StaticModel* {.importc: "Urho3D::StaticModel", header: "StaticModel.h".} = object of Drawable
...
proc constructStaticModel*(context: ptr Context): StaticModel {.
    importcpp: "Urho3D::StaticModel(@)", header: "StaticModel.h".}
