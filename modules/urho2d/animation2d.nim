...
type 
  Reference2D* {.importc: "Urho3D::Reference2D", header: "Animation2D.h".} = object 
...
type 
  MainlineKey2D* {.importc: "Urho3D::MainlineKey2D", header: "Animation2D.h".} = object 
    time* {.importc: "time_".}: cfloat
    references* {.importc: "references_".}: Vector[Reference2D]


proc constructMainlineKey2D*(): MainlineKey2D {.
...
type 
  Transform2D* {.importc: "Urho3D::Transform2D", header: "Animation2D.h".} = object 
...
proc constructTransform2D*(position: Vector2; angle: cfloat; scale: Vector2): Transform2D {.
    importcpp: "Urho3D::Transform2D(@)", header: "Animation2D.h".}
...
type 
  TimelineKey2D* {.importc: "Urho3D::TimelineKey2D", header: "Animation2D.h".} = object 
    time* {.importc: "time_".}: cfloat
...
proc constructTimelineKey2D*(): TimelineKey2D {.
    importcpp: "Urho3D::TimelineKey2D(@)", header: "Animation2D.h".}

type 
  Timeline2D* {.importc: "Urho3D::Timeline2D", header: "Animation2D.h".} = object 
...
type 
  Animation2D* {.importc: "Urho3D::Animation2D", header: "Animation2D.h".} = object of RefCounted
...
proc constructAnimation2D*(animationSet: ptr AnimationSet2D): Animation2D {.
    importcpp: "Urho3D::Animation2D(@)", header: "Animation2D.h".}
