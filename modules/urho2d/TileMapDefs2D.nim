...
type 
  TileMapInfo2D* {.importc: "Urho3D::TileMapInfo2D", header: "TileMapDefs2D.h".} = object 
...
type 
  PropertySet2D* {.importc: "Urho3D::PropertySet2D", header: "TileMapDefs2D.h".} = object of RefCounted
    nameToValueMapping* {.importc: "nameToValueMapping_".}: HashMap[UrString, 
        UrString]


proc constructPropertySet2D*(): PropertySet2D {.
...
type 
  Tile2D* {.importc: "Urho3D::Tile2D", header: "TileMapDefs2D.h".} = object of RefCounted
    gid* {.importc: "gid_".}: cint
    sprite* {.importc: "sprite_".}: SharedPtr[Sprite2D]
    propertySet* {.importc: "propertySet_".}: SharedPtr[PropertySet2D]


proc constructTile2D*(): Tile2D {.importcpp: "Urho3D::Tile2D(@)", 
                                  header: "TileMapDefs2D.h".}
...
type 
  TileMapObject2D* {.importc: "Urho3D::TileMapObject2D", 
...
proc constructTileMapObject2D*(): TileMapObject2D {.
    importcpp: "Urho3D::TileMapObject2D(@)", header: "TileMapDefs2D.h".}
