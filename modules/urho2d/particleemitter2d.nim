...
type
  Particle2D* {.importcpp: "Urho3D::Particle2D", header: "ParticleEmitter2D.h".} = object
...
type
  ParticleEmitter2D* {.importcpp: "Urho3D::ParticleEmitter2D",
...
proc constructParticleEmitter2D*(context: ptr Context): ParticleEmitter2D {.
    constructor, importcpp: "Urho3D::ParticleEmitter2D(@)", header: "ParticleEmitter2D.h".}
