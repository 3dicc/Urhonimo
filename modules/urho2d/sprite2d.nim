...
type
  Vertex2D* {.importcpp: "Urho3D::Vertex2D", header: "Sprite2D.h".} = object
...
type
  Sprite2D* {.importcpp: "Urho3D::Sprite2D", header: "Sprite2D.h".} = object of Resource
...
proc constructSprite2D*(context: ptr Context): Sprite2D {.
    constructor, importcpp: "Urho3D::Sprite2D(@)", header: "Sprite2D.h".}
