...
type
  TmxLayer2D* {.importcpp: "Urho3D::TmxLayer2D", header: "TmxFile2D.h".} = object of RefCounted
...
proc constructTmxLayer2D*(tmxFile: ptr TmxFile2D; `type`: TileMapLayerType2D): TmxLayer2D {.
    importcpp: "Urho3D::TmxLayer2D(@)", header: "TmxFile2D.h", constructor.}
...
type
  TmxTileLayer2D* {.importcpp: "Urho3D::TmxTileLayer2D", header: "TmxFile2D.h".} = object of TmxLayer2D
    tiles* {.importc: "tiles_".}: Vector[SharedPtr[Tile2D]]


proc constructTmxTileLayer2D*(tmxFile: ptr TmxFile2D): TmxTileLayer2D {.
    importcpp: "Urho3D::TmxTileLayer2D(@)", header: "TmxFile2D.h", constructor.}
...
type
  TmxObjectGroup2D* {.importcpp: "Urho3D::TmxObjectGroup2D", header: "TmxFile2D.h".} = object of TmxLayer2D
...
type
  TmxImageLayer2D* {.importcpp: "Urho3D::TmxImageLayer2D", header: "TmxFile2D.h".} = object of TmxLayer2D
...
type
  TmxFile2D* {.importcpp: "Urho3D::TmxFile2D", header: "TmxFile2D.h".} = object of Resource
...
proc constructTmxFile2D*(context: ptr Context): TmxFile2D {.
    constructor, importcpp: "Urho3D::TmxFile2D(@)", header: "TmxFile2D.h".}
