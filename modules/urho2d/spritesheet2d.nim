...
type
  SpriteSheet2D* {.importcpp: "Urho3D::SpriteSheet2D", header: "SpriteSheet2D.h".} = object of Resource
...
proc constructSpriteSheet2D*(context: ptr Context): SpriteSheet2D {.
    constructor, importcpp: "Urho3D::SpriteSheet2D(@)", header: "SpriteSheet2D.h".}
