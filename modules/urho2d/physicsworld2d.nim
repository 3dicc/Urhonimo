...
type
  PhysicsRaycastResult2D* {.importcpp: "Urho3D::PhysicsRaycastResult2D",
...
proc constructPhysicsRaycastResult2D*(): PhysicsRaycastResult2D {.constructor,
    importcpp: "Urho3D::PhysicsRaycastResult2D(@)", header: "PhysicsWorld2D.h".}

type
  PhysicsWorld2D* {.importcpp: "Urho3D::PhysicsWorld2D",
...
proc constructPhysicsWorld2D*(scontext: ptr Context): PhysicsWorld2D {.
    constructor, importcpp: "Urho3D::PhysicsWorld2D(@)", header: "PhysicsWorld2D.h".}
