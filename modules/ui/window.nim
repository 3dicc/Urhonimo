...
type
  WindowDragMode* {.importcpp: "Urho3D::WindowDragMode".} = enum
...
type
  Window* {.importcpp: "Urho3D::Window", header: "Window.h".} = object of BorderImage
...
proc constructWindow*(context: ptr Context): Window {.constructor,
