...
type
  ...
  CharLocation* {.importcpp: "Urho3D::CharLocation", header: "Text.h".} = object
    position* {.importc: "position_".}: IntVector2
    size* {.importc: "size_".}: IntVector2
  GlyphLocation* {.importcpp: "Urho3D::GlyphLocation", header: "Text.h".} = object
    x* {.importc: "x_".}: cint
    y* {.importc: "y_".}: cint
    glyph* {.importc: "glyph_".}: ptr FontGlyph

proc constructGlyphLocation*(x: cint; y: cint; glyph: ptr FontGlyph): GlyphLocation {.
    importcpp: "Urho3D::GlyphLocation(@)", header: "Text.h", constructor.}

type
  Text* {.importcpp: "Urho3D::Text", header: "Text.h".} = object of UIElement
