...
type
  PhysicsRaycastResult* {.importcpp: "Urho3D::PhysicsRaycastResult",
...
proc constructPhysicsRaycastResult*(): PhysicsRaycastResult {.constructor,
    importcpp: "Urho3D::PhysicsRaycastResult(@)", header: "PhysicsWorld.h".}

type
  DelayedWorldTransform* {.importcpp: "Urho3D::DelayedWorldTransform",
                           header: "PhysicsWorld.h".} = object
...
type
  PhysicsWorld* {.importcpp: "Urho3D::PhysicsWorld", header: "PhysicsWorld.h".} = object of Component
    when false:
...
proc getTypeNameStatic*(): UrString {.
    ...
    header: "PhysicsWorld.h".}
proc constructPhysicsWorld*(scontext: ptr Context): PhysicsWorld {.constructor,
