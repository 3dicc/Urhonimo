...
proc getType*(this: PhysicsWorld): Urho3D.StringHash {.noSideEffect, 
    importcpp: "GetType", header: "PhysicsWorld.h".}
proc getBaseType*(this: PhysicsWorld): Urho3D.StringHash {.noSideEffect, 
    importcpp: "GetBaseType", header: "PhysicsWorld.h".}
proc getTypeName*(this: PhysicsWorld): Urho3D.UrString {.noSideEffect, 
...
proc raycast*(this: var PhysicsWorld; 
              ...
              maxDistance: cfloat; collisionMask: cuint = m_Max_Unsigned) {.
