...
type
  CollisionGeometryData* {.importcpp: "Urho3D::CollisionGeometryData",
                           header: "CollisionShape.h".} = object of RefCounted



type
  TriangleMeshData* {.importcpp: "Urho3D::TriangleMeshData",
...
type
  ConvexData* {.importcpp: "Urho3D::ConvexData", header: "CollisionShape.h".} = object of CollisionGeometryData
...
proc constructConvexData*(model: ptr Model; lodLevel: cuint): ConvexData {.
    importcpp: "Urho3D::ConvexData(@)", header: "CollisionShape.h", constructor.}
proc constructConvexData*(custom: ptr CustomGeometry): ConvexData {.constructor,
...
type
  HeightfieldData* {.importcpp: "Urho3D::HeightfieldData",
                     header: "CollisionShape.h".} = object of CollisionGeometryData
...
type
  CollisionShape* {.importcpp: "Urho3D::CollisionShape",
