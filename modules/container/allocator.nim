...
type
  AllocatorBlock* {.importcpp: "Urho3D::AllocatorBlock", header: "Allocator.h".} = object
  ...
  AllocatorNode* {.importcpp: "Urho3D::AllocatorNode", header: "Allocator.h".} = object
...
proc constructAllocator*[T](initialCapacity: cuint = 0): Allocator[T] {.
    importcpp: "Urho3D::Allocator(@)", header: "Allocator.h", constructor.}
