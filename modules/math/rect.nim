...
type
  Rect* {.importcpp: "Urho3D::Rect", header: "Rect.h".} = object
...
type
  IntRect* {.importcpp: "Urho3D::IntRect", header: "Rect.h".} = object
...
proc constructIntRect*(left: cint; top: cint; right: cint; bottom: cint): IntRect {.
    importcpp: "Urho3D::IntRect(@)", header: "Rect.h", constructor.}
proc constructIntRect*(data: ptr cint): IntRect {.constructor,
