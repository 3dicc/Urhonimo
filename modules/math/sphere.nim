...
proc constructSphere*(center: Vector3; radius: cfloat): Sphere {.
    importcpp: "Urho3D::Sphere(@)", header: "Sphere.h", constructor.}
proc constructSphere*(vertices: ptr Vector3; count: cuint): Sphere {.
    importcpp: "Urho3D::Sphere(@)", header: "Sphere.h", constructor.}
proc constructSphere*(box: BoundingBox): Sphere {.constructor,
    importcpp: "Urho3D::Sphere(@)", header: "Sphere.h".}
proc constructSphere*(frustum: Frustum): Sphere {.constructor,
    importcpp: "Urho3D::Sphere(@)", header: "Sphere.h".}
proc constructSphere*(poly: Polyhedron): Sphere {.constructor,
    importcpp: "Urho3D::Sphere(@)", header: "Sphere.h".}
