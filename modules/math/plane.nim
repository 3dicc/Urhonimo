...
type
  Plane* {.importcpp: "Urho3D::Plane", header: "Plane.h".} = object
    normal* {.importc: "normal_".}: Vector3
    absNormal* {.importc: "absNormal_".}: Vector3
    d* {.importc: "d_".}: cfloat


proc constructPlane*(): Plane {.
  constructor, importcpp: "Urho3D::Plane(@)", header: "Plane.h".}
proc constructPlane*(plane: Plane): Plane {.importcpp: "Urho3D::Plane(@)",
  constructor, header: "Plane.h".}
