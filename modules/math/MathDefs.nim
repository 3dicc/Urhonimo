...
var M_PI* {.importc: "M_PI", header: "MathDefs.h".}: cfloat

var M_HALF_PI* {.importc: "M_HALF_PI", header: "MathDefs.h".}: cfloat

var M_MIN_INT* {.importc: "M_MIN_INT", header: "MathDefs.h".}: cint
var M_MAX_INT* {.importc: "M_MAX_INT", header: "MathDefs.h".}: cint

var M_MIN_UNSIGNED* {.importc: "M_MIN_UNSIGNED", header: "MathDefs.h".}: cuint
...
var M_DEGTORAD* {.importc: "M_DEGTORAD", header: "MathDefs.h".}: cfloat

var M_DEGTORAD_2* {.importc: "M_DEGTORAD_2", header: "MathDefs.h".}: cfloat

var M_RADTODEG* {.importc: "M_RADTODEG", header: "MathDefs.h".}: cfloat
...
proc equals*(lhs: cfloat; rhs: cfloat): bool {.inline.} =
  lhs + M_EPSILON >= rhs and lhs - M_EPSILON <= rhs

when false:
  # we don't need these or have our own in Nim
