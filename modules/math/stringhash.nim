...
type
  StringHash* {.importcpp: "Urho3D::StringHash", header: "StringHash.h".} = object
...
#    importcpp: "Urho3D::StringHash(@)", header: "StringHash.h".}
proc constructStringHash*(str: cstring): StringHash {.constructor,
    importcpp: "Urho3D::StringHash(@)", header: "StringHash.h".}
proc constructStringHash*(str: UrString): StringHash {.constructor,
    importcpp: "Urho3D::StringHash(@)", header: "StringHash.h".}
