...
type
  VAnimKeyFrame* {.importcpp: "Urho3D::VAnimKeyFrame", header: "ValueAnimation.h".} = object
...
type
  VAnimEventFrame* {.importcpp: "Urho3D::VAnimEventFrame",
...
type
  ValueAnimation* {.importcpp: "Urho3D::ValueAnimation",
