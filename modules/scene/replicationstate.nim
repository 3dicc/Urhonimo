...
proc constructDirtyBits*(): DirtyBits {.importcpp: "Urho3D::DirtyBits(@)",
              constructor, header: "ReplicationState.h".}
proc constructDirtyBits*(bits: DirtyBits): DirtyBits {.constructor,
...
proc constructNodeReplicationState*(): NodeReplicationState {.constructor,
