...
type 
  Serializable* {.importc: "Urho3D::Serializable", header: "Serializable.h".} = object of UrObject
...
proc getType*(this: Serializable): Urho3D.StringHash {.noSideEffect, 
    importcpp: "GetType", header: "Serializable.h".}
proc getBaseType*(this: Serializable): Urho3D.StringHash {.noSideEffect, 
    importcpp: "GetBaseType", header: "Serializable.h".}
proc getTypeName*(this: Serializable): Urho3D.UrString {.noSideEffect, 
...
proc getTypeNameStatic*(): Urho3D.UrString {.
    ...
    header: "Serializable.h".}
proc constructSerializable*(context: ptr Context): Serializable {.
...
type 
  AttributeAccessorImpl* {.importc: "Urho3D::AttributeAccessorImpl", 
...
proc constructAttributeAccessorImpl*[T, U](getFunction: GetFunctionPtr; 
    setFunction: SetFunctionPtr): AttributeAccessorImpl[T, U] {.
...
type 
  RefAttributeAccessorImpl* {.importc: "Urho3D::RefAttributeAccessorImpl", 
                              header: "Serializable.h".}[T, U] = object of AttributeAccessor
    getFunction* {.importc: "getFunction_".}: GetFunctionPtr
    setFunction* {.importc: "setFunction_".}: SetFunctionPtr
...
proc constructRefAttributeAccessorImpl*[T, U](getFunction: GetFunctionPtr; 
    setFunction: SetFunctionPtr): RefAttributeAccessorImpl[T, U] {.
