...
type
  Animatable* {.importcpp: "Urho3D::Animatable", header: "Animatable.h".} = object of Serializable
  ...
  AttributeAnimationInfo* {.importcpp: "Urho3D::AttributeAnimationInfo",
...
proc constructAnimatable*(context: ptr Context): Animatable {.
    constructor, importcpp: "Urho3D::Animatable(@)", header: "Animatable.h".}
