...
proc createScene() =
  ...
  for i in 0 ..< 200:
    ...
    mushroomNode[].setPosition(constructVector3(random.rand(90.0) - 45.0f32, 0.0f32,
                                                random.rand(90.0) - 45.0f32))
    mushroomNode[].setRotation(constructQuaternion(0.0f32, random.rand(360.0f32), 0.0f32))
    mushroomNode[].setScale(0.5f32 + random.rand(2.0f32))
